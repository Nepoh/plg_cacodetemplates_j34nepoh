 ...
 *
 * @version			$Id: architectcompordering.php 482 2015-04-06 17:48:54Z BrianWade $
...
/**
 * Supports an HTML ordering select list for objects in component [%%architectcomp_name%%]
 *
 */
class JFormField[%%ArchitectComp%%]Ordering extends JFormField
{
	/**
	 * The form field type.
	 *
