 ...
 * 
 * @version			$Id: mod_architectcomp_compobjectplural.php 482 2015-04-06 17:48:54Z BrianWade $
...
$list = Mod[%%CompObjectPlural%%]Helper::getList($params);
$module_class_sfx = htmlspecialchars($params->get('moduleclass_sfx'));

require JModuleHelper::getLayoutPath('mod_[%%architectcomp%%]_[%%compobjectplural%%]', $params->get('layout', 'default'));
