 ...
 *
 * @version			$Id: default.php 482 2015-04-06 17:48:54Z BrianWade $
		...
		<table class="table table-striped" id="[%%compobject%%]-list">
			<thead>
				<tr>
					...
					[%%IF INCLUDE_CREATED%%]
					<th width="10%" class="nowrap center hidden-phone">
						<?php echo JHtml::_('searchtools.sort',  '[%%COM_ARCHITECTCOMP%%]_HEADING_CREATED_BY', 'created_by_name', $list_dirn, $list_order); ?>
					</th>
					<th width="10%" class="nowrap center hidden-phone">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				[%%ENDIF GENERATE_CATEGORIES%%]
					...
					<td class="nowrap has-context">
						...
						[%%ENDIF INCLUDE_ASSETACL%%]
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=[%%com_architectcomp%%]&task=[%%compobject%%].edit&id='.(int) $item->id); ?>">
