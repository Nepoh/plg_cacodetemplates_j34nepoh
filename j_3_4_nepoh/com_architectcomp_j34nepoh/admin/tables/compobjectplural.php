...
[%%ENDIF INCLUDE_STATUS%%]
	...
	public function __construct(&$db)
	{
		...
		[%%IF INCLUDE_TAGS%%]
		JTableObserverTags::createObserver($this, array('typeAlias' => '[%%com_architectcomp%%].[%%compobject%%]'));
		[%%ENDIF INCLUDE_TAGS%%]

		[%%IF INCLUDE_VERSIONS%%]
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => '[%%com_architectcomp%%].[%%compobject%%]'));
