 ...
 *
 * @version			$Id: route.php 482 2015-04-06 17:48:54Z BrianWade $
...
abstract class [%%ArchitectComp%%]HelperRoute
{
	...
	[%%IF GENERATE_CATEGORIES%%]		 
		[%%IF INCLUDE_LANGUAGE%%]
	public static function get[%%CompObject%%]Route($id, $cat_id = 0, $language = 0, $layout = 'default', $keep_item_id = false)
	...
	[%%ELSE GENERATE_CATEGORIES%%]
		[%%IF INCLUDE_LANGUAGE%%]
	public static function get[%%CompObject%%]Route($id, $language = 0, $layout = 'default', $keep_item_id = false)
		[%%ELSE INCLUDE_LANGUAGE%%]
