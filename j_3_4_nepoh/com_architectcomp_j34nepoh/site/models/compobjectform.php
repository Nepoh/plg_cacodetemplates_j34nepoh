 ...
 *
 * @version			$Id: compobjectform.php 482 2015-04-06 17:48:54Z BrianWade $
...
require_once JPATH_ADMINISTRATOR.'/components/[%%com_architectcomp%%]/models/[%%compobject%%].php';

class [%%ArchitectComp%%]Model[%%CompObject%%]Form extends [%%ArchitectComp%%]Model[%%CompObject%%]
{
	/**
	...
	protected function populateState()
	{
		...
		$this->setState('[%%compobject%%].catid', $app->input->getInt('catid'));
