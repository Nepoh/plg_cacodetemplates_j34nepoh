 ...
 *
 * @version			$Id: categories.php 482 2015-04-06 17:48:54Z BrianWade $
...
/**
 * This models supports retrieving lists of [%%architectcomp%%] categories.
 *
 */
class [%%ArchitectComp%%]ModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = '[%%com_architectcomp%%].categories';
	 ...
	 * @var		string
	 */
	protected $_extension = '[%%com_architectcomp%%]';
