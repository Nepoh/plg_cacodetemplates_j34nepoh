 ...
 *
 * @version			$Id: article.php 482 2015-04-06 17:48:54Z BrianWade $
...
<div class="[%%architectcomp%%] [%%compobject%%]-article<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/Article">
	[%%IF INCLUDE_LANGUAGE%%]
